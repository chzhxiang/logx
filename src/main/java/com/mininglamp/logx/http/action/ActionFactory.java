...
public class ActionFactory {
	/**
	 * Collections of action with it's class mapping.
	 */
	@SuppressWarnings({ "unchecked", "unused" })
	private Map<Class,Object> actionMap = new HashMap<Class,Object>();
	private static StatViewAction action = new StatViewAction();
