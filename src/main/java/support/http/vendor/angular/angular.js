 ...
 * @example
  <example>
    <file name="index.html">
      ...
      <a ng-click="currentTpl='/view.html'" id="view-link">Load inlined template</a>
      <div id="view-content" ng-include src="currentTpl"></div>
    </file>
    <file name="protractor.js" type="protractor">
      it('should load template defined inside script tag', function() {
        element(by.css('#view-link')).click();
        expect(element(by.css('#view-content')).getText()).toMatch(/Content of the template/);
      });
    </file>
  </example>
 */
